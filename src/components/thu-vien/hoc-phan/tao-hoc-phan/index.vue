        ...
        <a-form ref="formRef" v-bind="layout" name="nest-messages">
          ...
          >
            <a-row>
              ...
              <a-col :span="10" style="margin-left: 20px; text-align: end">
                <a-input
              ...
              <a-col :span="3" style="margin-left: 15px">
                <a-form-item>
                  ...
                  />
                  <a-image :src="link" alt="" width="150px" />
                </a-form-item>
              </a-col>
            </a-row>
          </a-card>
...
export default defineComponent({
  ...
  setup() {
    ...
    const thuMuc = ref([])
    const SoThe = ref([
      { stt: 1, ngonNgu1: "", ngonNgu2: "", hinhAnh: null },
      { stt: 2, ngonNgu1: "", ngonNgu2: "", hinhAnh: null },
      { stt: 3, ngonNgu1: "", ngonNgu2: "", hinhAnh: null },
    ]);
    ...
    const handleOk = () => {
      ...
      SoThe.value.forEach((item) => {
        theHocsArray.push({
          ...
          hinhAnh: item.hinhAnh, // Sử dụng giá trị từ mảng SoThe
